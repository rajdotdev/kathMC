    ...
    <div className="mb-12">
      <div className="flex flex-col md:flex-row justify-between items-center gap-4 mb-6">
        ...
        <div className="flex w-full md:w-auto gap-4">
          ...
          <label className="flex-1 md:flex-none flex items-center justify-center px-4 py-3 bg-white neo-border neo-shadow font-bold uppercase text-sm cursor-pointer hover:bg-gray-50">
          ...
          <button
            ...
            className="flex-1 md:flex-none flex items-center justify-center px-4 py-3 bg-info neo-border neo-shadow font-bold uppercase text-sm cursor-pointer"
          >
              ...
              <tr key={student.id} className={`block md:table-row border-b-4 border-black last:border-b-0 ${idx % 2 === 0 ? 'bg-white' : 'bg-paper/50'} hover:bg-info/10 transition-colors`}>
                <td className="p-4 block md:table-cell border-b-2 border-dashed border-gray-200 md:border-none">
                  <div className="flex justify-between items-center md:block">
                    ...
                    <span className="font-mono text-lg font-bold">{student.rollNo || '-'}</span>
                  </div>
                </td>
                <td className="p-4 block md:table-cell border-b-2 border-dashed border-gray-200 md:border-none">
                  <div className="flex justify-between items-center md:block">
                ...
                <td className="p-4 block md:table-cell border-b-2 border-dashed border-gray-200 md:border-none">
                  <div className="flex justify-between items-center md:block">
                    ...
                    <div className="flex flex-col gap-1 text-sm">
                      {student.phone ? (
                        <a href={`https://wa.me/${student.phone.replace(/[^0-9]/g, '')}`} target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-green-600 hover:underline font-medium">
                          <MessageCircle className="w-4 h-4" /> {student.phone}
                        </a>
                      ) : <span className="text-gray-400">-</span>}
                      {student.email ? (
                        <a href={`mailto:${student.email}`} className="flex items-center gap-2 text-blue-600 hover:underline font-medium">
