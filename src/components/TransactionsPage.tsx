  ...
  return (
    <div className="mb-12 space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-primary p-6 neo-border neo-shadow-static flex items-center gap-4">
        ...
        <div className="bg-secondary p-6 neo-border neo-shadow-static flex items-center gap-4">
          <div className="p-4 bg-white neo-border rounded-full">
            <ReceiptText className="w-8 h-8 text-secondary" />
          </div>
          <div>
        ...
        <div className="bg-accent p-6 neo-border neo-shadow-static flex items-center gap-4">
          <div className="p-4 bg-white neo-border rounded-full">
                ...
                <tr key={transaction.id} className={`block md:table-row border-b-4 border-black last:border-b-0 ${idx % 2 === 0 ? 'bg-white' : 'bg-paper/50'} hover:bg-info/10 transition-colors`}>
                  <td className="p-4 block md:table-cell border-b-2 border-dashed border-gray-200 md:border-none">
                    <div className="flex justify-between items-center md:block">
                      ...
                      <span className="font-mono text-lg font-bold">{new Date(transaction.date).toLocaleDateString()}</span>
                    </div>
                  </td>
                  <td className="p-4 block md:table-cell border-b-2 border-dashed border-gray-200 md:border-none">
                    <div className="flex justify-between items-center md:block">
                      <span className="md:hidden font-bold uppercase text-xs text-gray-500">Student</span>
                      <span className="font-bold text-lg">{student?.name || 'Unknown Student'}</span>
                    </div>
                  </td>
                  <td className="p-4 block md:table-cell border-b-2 border-dashed border-gray-200 md:border-none">
                    <div className="flex justify-between items-center md:block">
                      <span className="md:hidden font-bold uppercase text-xs text-gray-500">Event</span>
                      <span className="font-bold text-lg">{event?.name || 'Global Payment'}</span>
                    </div>
                  </td>
                  <td className="p-4 block md:table-cell border-b-2 border-dashed border-gray-200 md:border-none">
                    <div className="flex justify-between items-center md:block">
                      <span className="md:hidden font-bold uppercase text-xs text-gray-500">Method</span>
                      <span className={`px-3 py-1 text-xs font-bold uppercase tracking-wider rounded-full border-2 border-black ${badgeColor}`}>
                  ...
                  <td className="p-4 block md:table-cell border-b-2 border-dashed border-gray-200 md:border-none">
                    <div className="flex justify-between items-center md:block">
                      ...
                      <span className="font-mono text-lg text-green-600 font-black">RS {formatCurrency(transaction.amount)}</span>
                    </div>
                  </td>
                  <td className="p-4 block md:table-cell border-b-2 border-dashed border-gray-200 md:border-none">
          ...
          <div className="bg-white neo-border neo-shadow-static w-full max-w-md print:border-none print:shadow-none print:max-w-full">
            ...
            <div className="p-4 border-t-4 border-black bg-paper flex justify-end gap-4 print:hidden">
              ...
              <button
                ...
                className="flex items-center gap-2 px-6 py-2 bg-primary text-black font-bold uppercase tracking-wider neo-border neo-shadow hover:bg-primary/80 transition-colors cursor-pointer"
              >
