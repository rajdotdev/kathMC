            ...
            <>
              ...
              <div className="relative w-full sm:w-auto">
                ...
                <select
                  ...
                  className="w-full sm:w-auto pl-10 pr-8 py-3 bg-white neo-border neo-shadow font-bold uppercase text-sm cursor-pointer focus:outline-none appearance-none"
                >
        ...
        <div className="flex flex-col lg:flex-row w-full lg:w-auto gap-3 lg:gap-4 ml-auto">
          {!hideEventSelector && (
            ...
            >
              ...
              {role === 'admin' && <option value="NEW_EVENT">+ Create New Event</option>}
            </select>
          )}

          {selectedEventId !== '' && role === 'admin' && (
            <div className="flex flex-col sm:flex-row w-full lg:w-auto gap-3 lg:gap-4">
              <button
                onClick={() => setIsBulkPaymentOpen(true)}
                className="w-full sm:w-auto flex items-center justify-center px-2 sm:px-4 py-3 bg-action text-white neo-border neo-shadow font-bold uppercase text-xs sm:text-sm cursor-pointer whitespace-nowrap"
              >
              ...
              <button
                ...
                className="w-full sm:w-auto flex items-center justify-center px-2 sm:px-4 py-3 bg-info neo-border neo-shadow font-bold uppercase text-xs sm:text-sm cursor-pointer whitespace-nowrap"
              >
              ...
              <button
                ...
                className="w-full sm:w-auto flex items-center justify-center px-2 sm:px-4 py-3 bg-red-400 text-black neo-border neo-shadow font-bold uppercase text-xs sm:text-sm cursor-pointer hover:bg-red-500 whitespace-nowrap"
              >
        ...
        <>
          ...
          <thead className="hidden md:table-header-group">
            <tr className="bg-paper border-b-4 border-black">
              ...
              {role === 'admin' && <th className="p-2 md:p-3 font-display text-base uppercase tracking-wide text-right print:hidden">Action</th>}
            </tr>
          </thead>
                ...
                <tr key={student.id} className={`block md:table-row border-b-4 border-black last:border-b-0 ${idx % 2 === 0 ? 'bg-white' : 'bg-paper/50'} hover:bg-info/10 transition-colors`}>
                  <td className="p-2 md:p-3 block md:table-cell border-b-2 border-dashed border-gray-200 md:border-none">
                    <div className="flex flex-col md:block gap-1">
                      ...
                      <span className="font-mono text-sm md:text-base font-bold break-words">{student.rollNo || '-'}</span>
                    </div>
                  </td>
                  <td className="p-2 md:p-3 block md:table-cell border-b-2 border-dashed border-gray-200 md:border-none">
                    <div className="flex flex-col md:block gap-1">
                      <span className="md:hidden font-bold uppercase text-xs text-gray-500">Student</span>
                      <span className="font-bold text-sm md:text-base break-words">{student.name}</span>
                    </div>
                  </td>
                  <td className="p-2 md:p-3 block md:table-cell border-b-2 border-dashed border-gray-200 md:border-none">
                    <div className="flex flex-col md:block gap-1">
                      <span className="md:hidden font-bold uppercase text-xs text-gray-500">Total</span>
                      <span className="font-mono text-sm md:text-base font-bold break-words">RS {formatCurrency(owed)}</span>
                    </div>
                  </td>
                  <td className="p-2 md:p-3 block md:table-cell border-b-2 border-dashed border-gray-200 md:border-none">
                    <div className="flex flex-col md:block gap-1">
                      <span className="md:hidden font-bold uppercase text-xs text-gray-500">Paid</span>
                      <span className="font-mono text-sm md:text-base text-green-600 font-bold break-words">RS {formatCurrency(paid)}</span>
                    </div>
                  </td>
                  <td className="p-2 md:p-3 block md:table-cell border-b-2 border-dashed border-gray-200 md:border-none">
                    <div className="flex flex-col md:block gap-1">
                      <span className="md:hidden font-bold uppercase text-xs text-gray-500">Remaining</span>
                      <span className="font-mono text-sm md:text-base text-red-600 font-bold break-words">RS {formatCurrency(remaining)}</span>
                    </div>
                  </td>
                  <td className="p-2 md:p-3 block md:table-cell border-b-2 border-dashed border-gray-200 md:border-none text-left md:text-center">
                    <div className="flex flex-col md:block gap-1">
                      <span className="md:hidden font-bold uppercase text-xs text-gray-500">Status</span>
                      {isPaid ? (
                        <div className="inline-flex flex-col items-center justify-center transform md:-rotate-2 bg-green-400 text-black border-2 border-black px-2 py-1 font-display uppercase tracking-widest text-xs shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] w-fit">
                          <span>Paid</span>
                        ...
                        <div className="inline-block bg-red-400 text-black border-2 border-black px-2 py-1 font-display uppercase tracking-widest text-xs shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] w-fit">
                          Unpaid
                        </div>
                      )}
                    </div>
                  ...
                  {role === 'admin' && (
                    <td className="p-2 md:p-3 block md:table-cell text-right print:hidden">
                      <div className="flex justify-end gap-2 w-full mt-2 md:mt-0">
                        {(isPaid || owed === 0) ? (
                          lastTransaction ? (
                            <button
