      ...
      <div className="flex flex-col md:flex-row justify-between items-center gap-4 mb-6">
        ...
        <div className="flex w-full md:w-auto gap-4">
          <button
            ...
            className="flex-1 md:flex-none flex items-center justify-center px-4 py-3 bg-white neo-border neo-shadow font-bold uppercase text-sm cursor-pointer"
          >
          ...
          <button
            ...
            className="flex-1 md:flex-none flex items-center justify-center px-4 py-3 bg-action text-white neo-border neo-shadow font-bold uppercase text-sm cursor-pointer"
          >
                  ...
                  >
                    ...
                    <div className="flex gap-2 w-full sm:w-auto">
                      ...
                      <button
                        ...
                        className="px-4 py-2 bg-red-400 text-black neo-border font-bold uppercase text-xs cursor-pointer hover:bg-red-500"
                      >
